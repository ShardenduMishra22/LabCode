...
INSERT INTO
    Users (username, email, signup_date)
VALUES (
        'john_doe',
        'john@example.com',
        '2024-01-01'
...
-- 8. Insert Sample Data into Posts Table
INSERT INTO
    Posts (user_id, post_date, content)
VALUES (
        1,
        '2025-02-01',
        'Post 1 content'
...
-- 9. Insert Sample Data into Likes Table
INSERT INTO
    Likes (post_id, user_id, like_date)
...
-- 10. Insert Sample Data into Comments Table
INSERT INTO
    Comments (
        post_id,
        user_id,
...
-- 11. SQL Queries to solve the exercise:
...
WHERE
    l.like_date >= CURDATE() - INTERVAL 7 DAY
GROUP BY
    u.user_id
HAVING
    likes_count > 10;
...
WHERE
    c.comment_date >= CURDATE() - INTERVAL 1 MONTH
GROUP BY
    u.user_id
HAVING
    comments_count > 5;
